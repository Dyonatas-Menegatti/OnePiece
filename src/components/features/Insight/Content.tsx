...
import { Coins, Flag, Gem, HandCoins, ListChecks, Target } from 'lucide-react';
			...
			<section className="flex flex-col gap-2">
				<div className="flex flex-col items-start gap-2 sm:flex-row">
					<div className="flex flex-row">
						...
						<Divider spacing={3} orientation="vertical" />
						<span className="text-foreground text-sm font-semibold">Viabilidade da rota</span>
					</div>
					{status && (
						<span
			...
			<section>
				<SectionTitle>
					<div className="flex flex-row">
						...
						<Divider spacing={3} orientation="vertical" />
						<span className="text-foreground text-sm font-semibold">Diagnóstico dos berries</span>
					</div>
				</SectionTitle>
			...
			<section>
				<SectionTitle>
					<div className="flex flex-row">
						...
						<Divider spacing={3} orientation="vertical" />
						<span className="text-foreground text-sm font-semibold">Táticas da tripulação</span>
					</div>
				</SectionTitle>
			...
			<section>
				<SectionTitle>
					<div className="flex flex-row">
						...
						<Divider spacing={3} orientation="vertical" />
						<span className="text-foreground text-sm font-semibold">Onde guardar o tesouro</span>
					</div>
				</SectionTitle>
			...
			<section>
				<SectionTitle>
					<div className="flex flex-row">
						...
						<Divider spacing={3} orientation="vertical" />
						<span className="text-foreground text-sm font-semibold">Mensagem do capitão</span>
					</div>
				</SectionTitle>
